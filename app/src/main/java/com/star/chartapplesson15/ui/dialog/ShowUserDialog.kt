...
import com.star.chartapplesson15.ui.adapter.UserAdapter
import kotlinx.android.synthetic.main.dialog.view.*

class ShowUserDialog(context: Context, status: String) : AlertDialog(context) {
    ...
    fun setValueData(ls: List<UsersData>) {
